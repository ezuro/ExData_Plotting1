...
par(mfrow=c(2,2))
  ...
  #plot1
  with(file, plot(FileDates,Global_active_power,type = "l",ylab = "Global Active Power",xlab = ""))

  #plot2
  with(file, plot(FileDates,Voltage,type = "l",ylab = "Voltage",xlab = "datetime"))
  ...
  #plot4
  with(file, plot(FileDates,Global_reactive_power,type = "l",ylab = "Global_reactive_power",xlab = "datetime"))
  



#Save to PNG file
dev.copy(png, file="CourseProjects/Exploratory_Analysis/CourseProject1/plot4.png",width = 480, height = 480)
dev.off()
